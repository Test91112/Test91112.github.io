...
session_start();
$conn = mysqli_connect('localhost', 'root', '', 'pharmacy') or die('unable to connect to DB');
?>
<!DOCTYPE html>
...
<div class="absCenter ">
  <div class="loaderPill">
   ...
   <!-- BASICS for the website <NAVBAR>(Sign in)-->
   <div class="navbar">
      <nav>
...
<div id="Sign_in_content">
  ...
  <?php if (isset($_GET['error'])) { ?>
    ...
    <a href="..\Sign in\Password_Change\Forget Password\Forget Password.php" id="ResetPassword">Forgot Password?</a>
  </form>
</div>
</div>
<script>
